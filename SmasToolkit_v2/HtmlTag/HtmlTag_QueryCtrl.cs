...
{
    public class QueryCtrl : IHtmlTag
    {
        ...
        public string RenderHtml()
        {
            ...
            return string.Format("<ddsc:QueryCtrl id='{0}' runat='server' ScriptOnclick='OpenQueryDialg(this);' Width='100px' AllowEmpty='{1}' MaxLength='7'></ddsc:QueryCtrl>",
                id,
