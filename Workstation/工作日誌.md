...
查詢來源
FIS.evaair.com
帳號密碼：AAFS_SMAS / SMAS_FIS0301

 <dataBase id="FIS" EventLog="false" EventLogPath="C:\com.ddsc.database">
    <dbType>ORACLE</dbType> 
    <dbServer>FIS.evaair.com</dbServer> 
    <userID>jHyn9Z/kwqvina1lEXmrr9RkLWl7v35/nZfI1cuNamA=</userID> 
    <userPW>zRHQto6m00AAYIZAT0bu32cIhYqiWhp5syQuoJiXgVQ=</userPW> 
...
寫入  smas
 ...
 p35egaseamst2015t071
  
 
 <dataBase id="EAMS" EventLog="false" EventLogPath="C:\com.ddsc.database">
    <dbType>ORACLE</dbType> 
    <dbServer>Testegasappl.evaair.com</dbServer> 
    <userID>Kp09JVuo0QcrXmGUzPzMyJPF6bBmyIVZ1J0I/oZXuoo=</userID> 
    <userPW>8B4j+tlHKKqHEigSDHd7BC1tW8gkXT+GbYFDqFxEvZQ=</userPW> 
    <connectionTimeOut>100000</connectionTimeOut> 
  </dataBase>
...
select
    '塞入的order_no不可重複' as order_no,
    '今天日期' as order_date, 
    arr as ariv_stn,
    dept_flt_no,
    AIRCRAFT_NO,
    GATE as DEPT_GATE,
    FLIGHT_ETD_TIME as dept_time, -- '201511121930'
    '轉檔時間' as order_notice_time, -- 201511121347
    0 as attach_mark,
    ...
    'current_date' as dept_time,
    'current_time' as alltime,
