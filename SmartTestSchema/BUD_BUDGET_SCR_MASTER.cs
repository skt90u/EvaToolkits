...
namespace SmartTestSchema
{
    ...
    public partial class BUD_BUDGET_SCR_MASTER
    {
        ...
        public Nullable<decimal> YEAR_RADIO { get; set; }
        public string LISTED_DEPT { get; set; }
        public string USE_DEPT { get; set; }
        public Nullable<decimal> BUDGET_AMT { get; set; }
        public Nullable<decimal> C_RADIO { get; set; }
    }
}
