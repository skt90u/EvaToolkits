...
namespace SmartTestSchema
{
    ...
    public partial class NGT_JOB_MASTER
    {
        public NGT_JOB_MASTER()
        {
            this.NGT_JOB_DETAILS = new HashSet<NGT_JOB_DETAILS>();
        }
        ...
        public virtual ICollection<NGT_JOB_DETAILS> NGT_JOB_DETAILS { get; set; }
    }
}
