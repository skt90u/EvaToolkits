...
namespace SmartTestSchema
{
    ...
    public partial class B2C_PROMOTION_DETAILS_20140115
    {
        public string PMT_ID { get; set; }
        public string PMT_DETAILS_ID { get; set; }
        public string B2C_CODE { get; set; }
        public Nullable<decimal> PRO_DISC { get; set; }
        public Nullable<short> PRO_QTY { get; set; }
        public string SKU_B2C_CODE { get; set; }
        public Nullable<short> SKU_AMT { get; set; }
