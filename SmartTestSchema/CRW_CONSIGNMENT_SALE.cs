...
namespace SmartTestSchema
{
    ...
    public partial class CRW_CONSIGNMENT_SALE
    {
        ...
        public string CSGMT_CODE { get; set; }
        public Nullable<short> SALE_QTY { get; set; }
        public Nullable<short> CSGMT_UNIT_PRICE { get; set; }
        public Nullable<decimal> CSGMT_UNIT_COST { get; set; }
