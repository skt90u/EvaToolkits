...
namespace SmartTestSchema
{
    ...
    public partial class CRW_INCENTIVE_BONUS_YM_SETTING
    {
        public string EFF_MONTH { get; set; }
        public string EXP_MONTH { get; set; }
        public int MONTH_MIN_AMT { get; set; }
        public Nullable<int> MONTH_MAX_AMT { get; set; }
        public Nullable<int> CREW_BONUS { get; set; }
