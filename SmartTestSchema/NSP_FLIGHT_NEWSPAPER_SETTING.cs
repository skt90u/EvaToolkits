...
namespace SmartTestSchema
{
    ...
    public partial class NSP_FLIGHT_NEWSPAPER_SETTING
    {
        public string NEWS_CODE { get; set; }
        public string FLIGHT_TYPE { get; set; }
        public short NEWS_QTY { get; set; }
        public Nullable<decimal> NEWS_RATIO { get; set; }
        public Nullable<short> NEWS_MIN_QTY { get; set; }
