...
namespace SmartTestSchema
{
    ...
    public partial class PRE_ORDER_PAYMENT_VIP
    {
        ...
        public string AUTH_APPROVECODE { get; set; }
        public Nullable<decimal> AUTH_TRANS_SEQNO { get; set; }
        public string AUTH_TRANS_DATE { get; set; }
        ...
        public string REAUTH_RESPONSE_CODE { get; set; }
