...
namespace SmartTestSchema
{
    ...
    public partial class NSP_NEWSPAPER_ANALYSIS
    {
        ...
        public Nullable<short> BOOKED_TTL_PAX { get; set; }
        public Nullable<short> BOOKED_TTL_QTY { get; set; }
        public Nullable<short> ONBOARD_TTL_PAX { get; set; }
        public Nullable<short> ONBOARD_TTL_QTY { get; set; }
