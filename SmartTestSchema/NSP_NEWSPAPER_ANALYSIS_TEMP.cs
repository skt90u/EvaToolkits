...
namespace SmartTestSchema
{
    ...
    public partial class NSP_NEWSPAPER_ANALYSIS_TEMP
    {
        ...
        public Nullable<short> BK_PAX_CNT { get; set; }
        public Nullable<decimal> BK_NEWS_QTY { get; set; }
        public Nullable<short> OB_PAX_CNT { get; set; }
        public Nullable<decimal> ON_NEWS_QTY { get; set; }
