...
namespace SmartTestSchema
{
    ...
    public partial class CRW_EXCHANGE_RATE
    {
        public string EXCH_TYPE { get; set; }
        public string EXCH_DATE { get; set; }
        public string CUR_DIVIDEND { get; set; }
        public string CUR_DIVISOR { get; set; }
        ...
        public string VIEW_EXCH_DATE { get; set; }
    }
}
